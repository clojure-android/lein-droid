...
** Documentation
   ...
   [[https://github.com/krisc][Kris Calabio]] put together [[https://github.com/alexander-yakushev/events/blob/master/tutorial.md][an amazing tutorial]] 
...
** License
   ...
   Eclipse Public License, the same as Clojure. See the file [[https://github.com/clojure-android/lein-droid/blob/master/COPYING][COPYING]].
