...
** Usage
   ...
   The current version of lein-droid is =0.2.0-beta1=. You can also
   check [[https://clojars.org/lein-droid][Clojars]] to see what is the latest non-snapshot version.
